    ...
    <div class="dashboard-cards">
        <div class="card">
            ...
            <?php if ($recent_vitals && !empty($recent_vitals)): ?>
                <p class="timestamp">Last updated: <?= date('M j, Y g:i A', strtotime($recent_vitals['Timestamp'])) ?></p>
            ...
            <?php endif; ?>
            <a href="vitals.php" class="btn">Enter New Vitals</a>
        </div>
        ...
        <div class="quick-actions">
            ...
            <div class="actions-grid">
                <a href="vitals.php" class="action-card">
                    ...
                    <h3>Record Vitals</h3>
                    <p>Log your latest health metrics quickly.</p>
                </a>
                <a href="vitals_history.php" class="action-card">
                    ...
                    <p>View All your previous Vitals</p>
                </a>
                <a href="chat.php" class="action-card">
                    ...
                    <p>Message your doctor directly.</p>
                </a>
                <a href="History.html" class="action-card">
                    ...
                    <h3>View Trends</h3>
                    <p>Analyze patterns in your health data.</p>
                </a>
                <a href="reports.php" class="action-card">
                    ...
                    <h3>View Reports</h3>
                    <p>Access detailed health reports.</p>
                </a>
            </div>
        </div>
    </div>
